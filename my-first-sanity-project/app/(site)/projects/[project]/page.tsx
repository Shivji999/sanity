...
export default async function Project({ params }: Props) {
    ...
    return <div>
 <div className="max-w-1xl py-10 m-4 md:py-20">
    <header className="grid grid-cols-1 md:grid-cols-1 items-center gap-8">
        <div className="md:col-span-1">
            <h1 className="text-2xl md:text-5xl font-bold tracking-tighter font-serif bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">
                {project.name}
            </h1>
        </div>
